...
* [`src/flow_me/`](src/flow_me/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/flow_me/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `flow-me` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/flow_me/config.cljs) defaults to `true` in
...
```clj
(ns flow-me.example
  (:require [flow-me.config :as config])
